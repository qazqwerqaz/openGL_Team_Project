...
void Joint::Set(Body* b1, Body* b2, const Vector2& anchor)
{
	body1 = b1;
	body2 = b2;

	Matrix2x2 Rot1(body1->rotation);
	Matrix2x2 Rot2(body2->rotation);
...
{
    Vector2 dv = body2->velocity + Cross(body2->angularVelocity, r2) - body1->velocity - Cross(body1->angularVelocity, r1);
